...
_G.packer_plugins = {
  ...
  ["filetype.nvim"] = {
    loaded = true,
    path = "/home/qwexvf/.local/share/nvim/site/pack/packer/start/filetype.nvim",
  ...
  ["impatient.nvim"] = {
    loaded = true,
    path = "/home/qwexvf/.local/share/nvim/site/pack/packer/start/impatient.nvim",
  ...
  ["nvim-colorizer.lua"] = {
    loaded = true,
    path = "/home/qwexvf/.local/share/nvim/site/pack/packer/start/nvim-colorizer.lua",
