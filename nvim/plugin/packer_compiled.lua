...
_G.packer_plugins = {
  ...
  LuaSnip = {
    loaded = true,
    path = "/home/qwexvf/.local/share/nvim/site/pack/packer/start/LuaSnip"
  },
  ["bufferline.nvim"] = {
    loaded = true,
  ...
  cmp_luasnip = {
    loaded = true,
    path = "/home/qwexvf/.local/share/nvim/site/pack/packer/start/cmp_luasnip"
  },
  ["coq.artifacts"] = {
    loaded = true,
    path = "/home/qwexvf/.local/share/nvim/site/pack/packer/start/coq.artifacts"
  },
  coq_nvim = {
    loaded = true,
    path = "/home/qwexvf/.local/share/nvim/site/pack/packer/start/coq_nvim"
  },
  ["gitsigns.nvim"] = {
    loaded = true,
